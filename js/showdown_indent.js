...
(function() {
    var a = function(a) {
        return [{
            ...
            replace: function(a, b, c) {
                return b === "\\" ? a : '<a href="http://twitter.com/' + c + '">@' + c + "</a>"
            }
        }, {
            type: "lang",
            regex: "\\B(\\\\)?#([\\S]+)\\b",
            replace: function(a, b, c) {
                return b === "\\" ? a : '<a href="http://twitter.com/search/%23' + c + '">#' + c + "</a>"
            }
        }, {
            type: "lang",
            regex: "\\\\@",
    ...
    typeof window != "undefined" && window.Showdown && window.Showdown.extensions && (window.Showdown.extensions.twitter = a), typeof module != "undefined" && (module.exports = a)
})();
...
(function() {
    var a = function(a) {
        var b = {},
            c = "text-align:left;",
            d;
        return b.th = function(a) {
            if (a.trim() === "") return "";
            var b = a.trim().replace(/ /g, "_").toLowerCase();
            return '<th id="' + b + '" style="' + c + '">' + a + "</th>"
        }, b.td = function(b) {
            return '<td style="' + c + '">' + a.makeHtml(b) + "</td>"
        }, b.ths = function() {
            var a = "",
                c = 0,
                d = [].slice.apply(arguments);
            for (c; c < d.length; c += 1) a += b.th(d[c]) + "\n";
            return a
        }, b.tds = function() {
            var a = "",
                c = 0,
                d = [].slice.apply(arguments);
            for (c; c < d.length; c += 1) a += b.td(d[c]) + "\n";
            return a
        }, b.thead = function() {
            var a, c = 0,
                d = [].slice.apply(arguments);
            ...
            var c = 0,
                ...
                e = [],
                f, g, h, i = [];
            for (c; c < d.length; c += 1) {
                f = d[c];
                if (f.trim().match(/^[|]{1}.*[|]{1}$/)) {
                    f = f.trim(), e.push("<table>"), g = f.substring(1, f.length - 1).split("|"), e.push(b.thead.apply(this, g)), f = d[++c];
                    if (!!f.trim().match(/^[|]{1}[-=| ]+[|]{1}$/)) {
                        f = d[++c], e.push("<tbody>");
                        while (f.trim().match(/^[|]{1}.*[|]{1}$/)) f = f.trim(), e.push(b.tr.apply(this, f.substring(1, f.length - 1).split("|"))), f = d[++c];
                        e.push("</tbody>"), e.push("</table>"), i.push(e.join("\n"));
                        continue
                    }
                    f = d[--c]
                }
    ...
    typeof window != "undefined" && window.Showdown && window.Showdown.extensions && (window.Showdown.extensions.table = a), typeof module != "undefined" && (module.exports = a)
})();
...
(function() {
    var a = function(a) {
        return [{
            type: "output",
            filter: function(a) {
                return a.replace(/(<pre>)<code>/gi, function(a, b) {
                    return b ? '<pre class="prettyprint" tabIndex="0"><code data-inner="1">' : '<code class="prettyprint">'
                })
            }
        }]
    };
...
(function() {
    ...
    typeof window != "undefined" && window.Showdown && window.Showdown.extensions && (window.Showdown.extensions.github = a), typeof module != "undefined" && (module.exports = a)
})();